...
class PhiInterpolator2D extends Interpolator2D {
	public double targetMeshEpsilon= 0.1;
	public double physicalDistanceEpsilon= 0.01;
	public int maxPhysicalDistanceIterations= 30;
