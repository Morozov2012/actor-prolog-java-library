...
public abstract class Interpolator2D {
	//
	protected int meshWidth= 7;
	protected int meshHeight= 7;
	protected double meshEpsilon= 0.1;
	//
	///////////////////////////////////////////////////////////////
	//
	...
	///////////////////////////////////////////////////////////////
	//
	abstract public double computeMatrixItem(int pX, int pY, double[][] extraArguments1, double[][] extraArguments2);
	abstract public double computeDefaultValue();
}
