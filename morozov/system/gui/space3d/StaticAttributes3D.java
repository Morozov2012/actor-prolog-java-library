...
public class StaticAttributes3D extends StaticAttributes {
	//
	protected Map<AbstractWorld,InternalFrame3D> innerWindows= Collections.synchronizedMap(new HashMap<AbstractWorld,InternalFrame3D>());
	protected static final String staticIdentifier= "Canvas3D";
	//
